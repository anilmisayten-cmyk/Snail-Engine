...
class CreditsState extends MusicBeatState
{
	...
	static final hardcodedCredits:Array<Array<String>> = [
		// NMV devs
		['SNAIL ENGINE'],
		['Emir Anilmis', 'emir', 'Programmer of Snail Engine', 'https://www.youtube.com/@CodeOyun2', '0xA8324A'],
		['PRIDEL3SS', 'pridel', 'Programmer of Snail Engine', '', '0xF9A250'],
		['Croxe', 'amcik', 'He Didnt work)', '', '0x9B00B3'],
		['Code:Mami', 'mami', 'Gives An ideas', 'https://www.youtube.com/@CodeMami34', '0x3366CC'],
		['Code:Karjaa', 'karja', 'Gives A Lot Of The İdeas', '', '0x7a346905'],
		['MR Dicdator', 'dicdator', 'Gives A Lot Of The İdeas, And Relases The Game', 'https://www.youtube.com/@mrdicdatoroffical', '0x6ede0b'],
		['Purfix', 'purfix', 'Artist Of the Logo And Credits Menu', '', '0x6ede0b'],
		['Kerem', 'kerem', 'He sat and did nothing.', '', '0x6ede0b'],
		['Boyfriend', 'bf', 'Artist. Credits', '', '0x6ede0b'],
