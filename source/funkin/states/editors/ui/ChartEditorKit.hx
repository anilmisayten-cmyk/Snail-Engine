...
class ChartEditorUI extends flixel.group.FlxSpriteContainer
{
	...
	public function bind():Void
	{
		...
		songDialog.findComponent("saveChartButton", haxe.ui.components.Button).onClick = function(event) charter.saveLevel();
		songDialog.findComponent("loadChartButton", haxe.ui.components.Button).onClick = function(event) charter.loadChart();
		songDialog.findComponent("saveEventsButton", haxe.ui.components.Button).onClick = function(event) charter.saveEvents();
		songDialog.findComponent("loadEventsButton", haxe.ui.components.Button).onClick = function(event) charter.loadEvents();
